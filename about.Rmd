...
```
There may be warnings about packages not installed necessary for developing packages, this can be ignored or you can install the package if you so choose. 
<br><br><br>
...
```{r fishloc, message=FALSE,warning=FALSE}
library("DT")
